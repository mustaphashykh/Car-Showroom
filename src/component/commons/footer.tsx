    ...
    return (
        <div className={absoute ? 'mt-8 absolute bottom-0 w-full': 'mt-8'}>
            <div className="bg-main-color text-white pt-2 pl-7 pb-4">
                ...
                <div className='text-[0.5rem] text-white pl-10 flex flex-col gap-0.5'>
                    ...
                    <div className='flex gap-1 text-[0.8rem]'>
                        <div className='bg-high-light-color w-4 h-4 flex items-center justify-center'>
            ...
            <div className='bg-high-light-color text-center text-[0.45em] text-white drop-shadow'>All Rights Reserved Ⓒ by Revilo Automotive ®</div>
        </div>
    )
}
